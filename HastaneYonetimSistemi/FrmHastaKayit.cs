...
namespace HastaneYonetimSistemi
{
    public partial class FrmHastaKayit : Form
    {
        ...
        private void BtnHastaKayit_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p4", MskhastaTelefon.Text);
            komut.Parameters.AddWithValue("@p5", TxtHastaSifre.Text);
            komut.Parameters.AddWithValue("@p6", CmbHastaCinsiyet.Text);
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Kaydınız Başarıyla Gerçekleşmiştir, Şifreniz :" + TxtHastaSifre.Text, "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
